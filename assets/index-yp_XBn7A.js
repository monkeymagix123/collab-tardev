...
class Game {
  constructor() {
     ...
     */
    __publicField(this, "coinsPerClick", computed(() => 1));
    /**
...
const _sfc_main$3 = {
  ...
  props: {
    dimension: Number,
    onBuyClick: Function
    // Define the prop as a Function type
  },
  setup(__props) {
    const props = __props;
...
const _hoisted_4 = { class: "flex-1 p-6" };
            ...
            (openBlock(), createElementBlock(Fragment, null, renderList(tabs, (tab) => {
              return createBaseVNode("li", {
                ...
                class: normalizeClass([
                  "p-4 cursor-pointer",
                  activeTab.value === tab.name ? "bg-gradient-to-r from-blue-600 to-purple-700 text-white font-semibold shadow-lg" : "text-white/75 hover:text-white hover:bg-white/10"
                ]),
                onClick: ($event) => activeTab.value = tab.name
